...
function getPosts ()
{
    ...
    $posts[1] = $_POST['code'];
    $posts[2] = $_POST['doc_name'];
    $posts[3] = $_POST['spealization'];
    $posts[4] = $_POST['hos_name'];
...
if(isset($_POST['search']))
{
    ...
    $search_Query = "SELECT doc_name,code,spealization,hos_name,address,phone_no,map FROM doctors WHERE code = '$data[1]'";
...
.hideme
{
  ...
  <fieldset class="form-fieldset">
          <legend class="form-legend">BOOK AN APPOINTMENT</legend>
        ...
        <div class="form-element form-input">
            <input id="field-uyzeji-352rnc-4rv3g1-bvlh88-9dewuz" name="doc_name" value="<?php echo $doc_name;?>" class="form-element-field" placeholder=" " type="input" />
            <div class="form-element-bar"></div>
            <label class="form-element-label" for="field-uyzeji-352rnc-4rv3g1-bvlh88-9dewuz">Doctor Name</label>
            </label>
        </div>
        <div class="form-element form-input">
            <input id="field-uyzeji-352rnc-4rv3g1-bvlh88-9dewuz" name="spealization" value="<?php echo $spealization;?>" class="form-element-field" placeholder=" " type="input"/>
            <div class="form-element-bar"></div>
            <label class="form-element-label" for="field-uyzeji-352rnc-4rv3g1-bvlh88-9dewuz">Specialisation</label>
        </div>
        <div class="form-element form-input">
            <input id="field-uyzeji-352rnc-4rv3g1-bvlh88-9dewuz" name="hos_name" value="<?php echo $hos_name;?>" class="form-element-field" placeholder=" " type="input" />
            <div class="form-element-bar"></div>
            <label class="form-element-label" for="field-uyzeji-352rnc-4rv3g1-bvlh88-9dewuz">Hospital Name</label>
            </label>
        </div>
        <div class="form-element form-input">
      ...
      <div class="form-actions">
          <button class="form-btn" name="submit"  type="submit" formaction="send_sms.php" style="padding:1rem;font-size:1.5rem">Send inquiry</button>
...
<script>document.addEventListener("change", function(event) {
  ...
  if (isset($_POST["from"]))
    ...
    $doc_name = $_POST["doc_name"].PHP_EOL;
    $address = $_POST["address"].PHP_EOL;
    $hos_name = $_POST["hos_name"].PHP_EOL;
    $spealization = $_POST["spealization"].PHP_EOL;
    ...
    $message="Doctor Name:".$doc_name."Address:".$address."Specialisation:".$spealization."Your Name:".$customer_name."Email:".$customer_email."Contact Number:".$contact_number."Date:".$date."Time:".$time."Location:".$map;
